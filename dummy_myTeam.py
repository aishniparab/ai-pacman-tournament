...
#COPY THIS FILE TO myTeam.py BEFORE SUBMITTING
...
class CollaborativeAgent(ReflexCaptureAgent):
  ...
  def getWeights(self, gameState, action):
    ...
    best_weights = [67.2, -4.2, -68.9, -45.9, -81.6, -84.6, -15.3, -34.4, 43.0, -137.2, -7.42]
    succ,firsteat,stepback,secondeat,eatinv,eatfd,eatpp,eatghst,ghostnear,stop,rev=best_weights
